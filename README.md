...
```javascript
float64ToFloat32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-to-float32@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/number-float64-base-to-float32/tags). For example,

```javascript
float64ToFloat32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-to-float32@v0.2.2-umd/browser.js' )
```
